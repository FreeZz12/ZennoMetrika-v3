...
stargate_pool_native_arbitrum = w3.to_checksum_address('0xA45B5130f36CDcA45667738e2a258AB09f4A5f7F')


def get_stargate_fee(to_chain: Chain, amount_wei: int) -> tuple[int, int]:
    contract = w3.eth.contract(address=stargate_pool_native_arbitrum, abi=get_abi('stargate_pool_native'))
