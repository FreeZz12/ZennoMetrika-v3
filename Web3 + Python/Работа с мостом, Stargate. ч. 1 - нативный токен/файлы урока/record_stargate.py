...
"""
0003010031020000000000000000000 - неизвестные параметры
1c6bf52634000 - сумма
000000000000000000000000624c222fed7f88500afa5021cc760b3106fe34be - адрес 32 байта
"""
...
def get_stargate_fee(to_chain: Chain, amount_wei: int) -> tuple[int, int]:
    address_contract = w3.to_checksum_address('0xe8CDF27AcD73a434D661C84887215F7598e7d0d3')
    contract = w3.eth.contract(address=address_contract, abi=get_abi('stargate_pool_native'))
...
def bridge(to_chain: Chain, amount: Amount):
    ...
    fee = get_stargate_fee(to_chain, amount.wei)
...
def main():
    ...
    bridge(to_chain=Chains.Arbitrum, amount=amount)
