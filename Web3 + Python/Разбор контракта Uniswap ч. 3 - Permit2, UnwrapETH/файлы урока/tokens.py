...
class Tokens:
    ...
    OP_OP = Token('OP', '0x4200000000000000000000000000000000000042', 18, Chains.Optimism,
                    TokenType.ERC20)
    ...
    WETH_ARBITRUM = Token('WETH', '0x82af49447d8a07e3bd95bd0d56f35241523fbab1', 18, Chains.Arbitrum,
                          TokenType.WRAPPED)
    WETH_OP = Token('WETH', '0x4200000000000000000000000000000000000006', 18, Chains.Optimism,
                          TokenType.WRAPPED)
    ...
    @classmethod
    def get_native(cls, chain: Chain) -> Token:
