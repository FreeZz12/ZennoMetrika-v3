...
library Constants {
    ...
    uint256 internal constant NEXT_V3_POOL_OFFSET = 20 + 3;

    /// @dev The offset of an encoded pool key
    /// Token (20) + Fee (3) + Token (20) = 43
    uint256 internal constant V3_POP_OFFSET = 23 + 20;

    /// @dev The minimum length of an encoding that contains 2 or more pools
    uint256 internal constant MULTIPLE_V3_POOLS_MIN_LENGTH = 43 + 23; // 66 * 2 = 132
}