...
что они будут запускаться раз в 5 дней.
...
и уведомляет если это начало происходить.
...
запускает несколько раз за цикл, это значит, что профиль добавлен несколько
